...
## About Our Site 💧🔥
Our website was created to gather important information about Disaster Safety and Civil Protection in one place. We wanted everything to be easy to find, understandable, and well-organized. <br>

Using modern technologies such as HTML, CSS, JavaScript, and libraries like Chart.js and Leaflet.js, we built a platform where people can: <br>

🌪️ Monitor in real time where emergency teams and vehicles are located <br>

🌊 See on the map where disasters such as floods, earthquakes, fires, or other incidents have occurred <br>

📊 View statistics and reports and filter them by date, disaster type, and location <br>

👷 Find information about emergency staff, response teams, and available equipment <br>

🚨 The goal of the project is to make everything convenient, fast, and accessible — both for citizens and for emergency responders. <br>
<h2>Tech Stack 🔧</h2>
